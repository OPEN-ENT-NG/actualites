...
public class ThreadControllerV1 extends ControllerHelper {
    ...
    @SecuredAction(value = "actualites.threads.list")
    ...
    @SecuredAction(value = THREAD_CONTRIB_VALUE, right = THREAD_CONTRIB_RIGHT, type = ActionType.RESOURCE)
    ...
    @ResourceFilter(ThreadFilter.class)
    @SecuredAction(value = "actualites.create")
    ...
    @ResourceFilter(ThreadFilter.class)
    @SecuredAction(value = THREAD_MANAGER_VALUE, right = THREAD_MANAGER_RIGHT, type = ActionType.RESOURCE)
